...
class TuiPetApp(ActionsMixin, App):
    ...
    WHATS_NEW = ("THE SHOP STOPS CHANGING ITS MIND: the line teasing "
                 "which sealed relic wakes next could pick a different "
                 "answer every time you launched the game — same pet, "
                 "same progress, different hint. It now names the "
                 "closest goal and keeps naming it. Behind that, a full "
                 "audit of the shops: 26 town counters, the deals, the "
                 "egg bands, the ledger and every panel were driven and "
                 "measured, and they all held — including the trade "
                 "game, where every profitable run between towns is "
                 "still rationed to a few units a day.")
